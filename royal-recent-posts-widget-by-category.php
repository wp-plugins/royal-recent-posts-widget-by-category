...
{
	$sizes = get_option('rt_cat_post_thumb_sizes');
	if ( $sizes )
	{
...
class RRPWbC extends WP_Widget {

function RRPWbC() {
	parent::WP_Widget(false, $name='Royal Recent Posts');
}
...
function update($new_instance, $old_instance) {
	if ( function_exists('the_post_thumbnail') )
	{
		...
		update_option('rt_cat_post_thumb_sizes', $sizes);
	}
...
add_action( 'widgets_init', create_function('', 'return register_widget("RRPWbC");') );
